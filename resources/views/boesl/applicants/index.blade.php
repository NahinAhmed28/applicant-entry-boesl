            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg mb-6" x-data="{ inputMode: '{{ session('input_mode', 'none') }}', fileName: '' }">
                <div class="p-4 sm:p-6 text-gray-900">
                    <div class="flex flex-col sm:flex-row gap-4 mb-4">
                        ...
                        <button @click="inputMode = 'batch'" :class="inputMode === 'batch' ? 'bg-blue-600 text-white shadow-md' : 'bg-gray-100 text-gray-700 hover:bg-gray-200'" class="flex-1 py-3 px-4 rounded-lg font-bold transition-all duration-200 flex items-center justify-center gap-2">
